...
`func (o *MultiFieldReqWithOptions) SetCountriesNil(b bool)`

 SetCountriesNil sets the value for Countries to be an explicit nil

### UnsetCountries
`func (o *MultiFieldReqWithOptions) UnsetCountries()`
...
### SetExcludedCountriesNil

`func (o *MultiFieldReqWithOptions) SetExcludedCountriesNil(b bool)`

 SetExcludedCountriesNil sets the value for ExcludedCountries to be an explicit nil

### UnsetExcludedCountries
`func (o *MultiFieldReqWithOptions) UnsetExcludedCountries()`

UnsetExcludedCountries ensures that no value is present for ExcludedCountries, not even an explicit nil
